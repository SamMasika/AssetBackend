...
<!-- Mirrored from themesbrand.com/agroxa/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Feb 2023 11:37:07 GMT -->
<head>
    ...
    <div class="navbar-header">
        ...
        <script src="{{asset('master/assets/libs/jquery-sparkline/jquery.sparkline.min.js')}}"></script>

        <!-- Peity JS -->
        <script src="{{asset('master/assets/libs/peity/jquery.peity.min.js')}}"></script>

        <script src="{{asset('master/assets/libs/morris.js/morris.min.js')}}"></script>

        <script src="{{asset('master/assets/libs/raphael/raphael.min.js')}}"></script>
...
<!-- Mirrored from themesbrand.com/agroxa/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Feb 2023 11:39:12 GMT -->
</html>